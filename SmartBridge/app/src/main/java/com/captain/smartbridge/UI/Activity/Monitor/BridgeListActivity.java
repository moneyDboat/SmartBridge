...
/**
 * Created by captain on 18-4-13.
 */

public class BridgeListActivity extends AbsActivity {
    @BindView(R.id.bridgelist_toolbar)
    Toolbar toolbar;
    @BindView(R.id.bridgelist_list)
    ListView bridgeList;
    ...
    protected void setSelfContentView() {
        setContentView(R.layout.activity_bridgelist);
    }
