...
public class DeMissionComAdapter extends BaseAdapter{
    private static int counter = 0;
    List<Mission> mData = null;
    Context mContext = null;

    public DeMissionComAdapter(Context context, List<Mission> data){
        mContext = context;
        mData = data;
        counter = 0;
    }
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            holder.imageView = (ImageView) rootView.findViewById(R.id.mission_arrow);
