...
public class WaterBridgeListActivity extends AbsActivity {
    @BindView(R.id.waterbridgelist_toolbar)
    Toolbar toolbar;
    @BindView(R.id.waterbridgelist_list)
    ListView bridgeList;
    ...
    protected void setSelfContentView() {
        setContentView(R.layout.activity_waterbridgelist);
    }
    ...
    protected void initViews() {
        ...
        bridgeList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(getApplication(), WaterActivity.class);
